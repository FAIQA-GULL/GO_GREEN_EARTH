...
<script language="javascript">
    function changeImage() {
        ...
        if (document.getElementById("imgClickAndChange").src == "pic/avatar.png") 
        {
            document.getElementById("imgClickAndChange").src = "pic/clover.png";
        }
        else 
        {
            document.getElementById("imgClickAndChange").src = "pic/basil.jpg";
        }
    }
</script> -->
...
$result = $conn->query("SELECT * FROM user_info WHERE user_id = 1");
...
<div class="container">
    <div class="user-box">
        <div class="img-relative">
            ...
            <!-- Image update link -->
            <a class="editLink" href="javascript:void(0);"><img src="pic/edit.png" style="width: 50%; height: 60%;" /></a>
            <!-- Profile image -->
            <img src="<?php echo $userPictureURL; ?>" id="imagePreview">
        </div>
        <div class="name">
            <h4><?php echo $row['user_name']; ?></h3>
        </div>
    </div>
</div>
