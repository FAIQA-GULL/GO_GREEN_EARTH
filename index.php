  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="activity.php">Area Covered Record</a></li>
...
<!-- </div> -->
  <!-- <img src="pic/clover-12.png" style=" width: 100%; height: 50%; object-fit: cover; position: fixed;"> -->
<!-- <div class="main_div"> -->
  ...
  <!-- login & register button -->
	<div class="container text-center">
		<div class="row">
      <div class="col">
			<!-- <img src="pic/clover-12.png" style=" width: 100%; height: 0%; object-fit: cover;"> -->
    ...
    <div class="container-fluid text-center">
      <h1>Learn Services </h1>
    	<div class="row text-center table-striped table-bordered">
    		<!-- <div class="col text-center table-striped table-bordered"> -->
    		<!-- 	<h1>Learn Services </h1> -->
    			<!-- <div class="container-fluid">
    				<div class="row"> -->
    					<div class="col ">
